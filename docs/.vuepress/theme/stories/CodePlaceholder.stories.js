...
<div class="language-twig extra-class"><pre class="language-twig"><code><span class="token tag"><span class="token ld"><span class="token punctuation">{%</span> <span class="token keyword">set</span></span> <span class="token property">field</span> <span class="token operator">=</span> <span class="token property">token</span><span class="token punctuation">.</span><span class="token property">app</span><span class="token punctuation">.</span><span class="token property">fields</span><span class="token punctuation">.</span><span class="token property">getFieldByHandle</span><span class="token punctuation">(</span><span class="token string"><span class="token punctuation">'</span><code-placeholder>FieldHandle</code-placeholder><span class="token punctuation">'</span></span><span class="token punctuation">)</span> <span class="token rd"><span class="token punctuation">%}</span></span></span>
