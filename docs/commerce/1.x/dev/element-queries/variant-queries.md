...
Once you’ve created a variant query, you can set [parameters](#parameters) on it to narrow down the results, and then [execute it](https://craftcms.com/docs/1.x/element-queries.html#executing-element-queries) by calling `.all()`. An array of [Variant](commerce3:craft\commerce\elements\Variant) objects will be returned.

::: tip
See [Element Queries](https://craftcms.com/docs/1.x/element-queries.html) in the Craft docs to learn about how element queries work.
:::
...
See [Eager-Loading Elements](https://craftcms.com/docs/1.x/dev/eager-loading-elements.html ) for a full explanation of how to work with this parameter.
