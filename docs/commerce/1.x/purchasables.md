...
The core of anything sold with Commerce is a purchasable, a custom [element type](https://craftcms.com/docs/1.x/extend/element-types.html) that can be added to a cart.

It should be extended to add useful attributes like Commerce’s included [product variant](products.md#variants) and [donation](donations.md) purchasables. [Plugins and modules](https://craftcms.com/docs/1.x/extend/) can provide their own purchasables.
...
::: tip
Craft 3.1 added [soft delete support](https://craftcms.com/docs/1.x/extend/soft-deletes.html) for all element types, including purchasables. You might want to familiarize yourself with soft deletion before adding delete and restore capabilities for your purchasable element.
:::
