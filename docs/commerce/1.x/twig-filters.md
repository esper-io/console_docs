...
This can be used as a drop-in replacement for [Craft’s `|currency` filter](https://craftcms.com/docs/1.x/dev/filters.html#currency), but it offers additional parameters for control over formatting and conversion:
