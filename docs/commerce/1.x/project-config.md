...
Craft 3.1 introduced the [**project config**](https://craftcms.com/docs/1.x/project-config.html), a sharable configuration store that makes it easier for developers to collaborate and deploy site changes across multiple environments.
