...
::: tip
Users will only be purged when [garbage collection](https://craftcms.com/docs/1.x/gc.html) is run.
:::
...
If you have a [decoupled front-end](https://craftcms.com/docs/1.x/entries.html#previewing-decoupled-front-ends), you will need to include
